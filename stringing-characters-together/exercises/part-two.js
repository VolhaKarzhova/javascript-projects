...
let dnaUpdated = dna.trim();
console.log(dnaUpdated);

//2) Change all of the letters in the dna string to UPPERCASE, then print the result.
let dnaUpperCase = dnaUpdated.toUpperCase();
...
const length = dnaTwo.length;
console.log(`The DNA strand is ${length} characters long.`);

//5) Just for fun, apply methods to ``dna`` and use another template literal to print, 'taco cat'.
const tac = dnaTwo.slice(4,7).toLowerCase();
const cat = dnaTwo.slice(40, 43).toLowerCase();
